...
public class SubActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button Btn2 = findViewById(R.id.Btn2Click);
        Btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast toast = Toast.makeText(view.getContext(), "zz", Toast.LENGTH_LONG);
    ...
    public void Btn2Click(View view) { // activity_sub의 onClick이랑 메소드 이름이 같아야 함
        // Toast 메시지를 띄우는 작업
